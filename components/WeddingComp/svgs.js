...
export const Svg1 = () => {
  const Svg1Inview = useInView({ threshold: .3, triggerOnce: true });
  ...
  useEffect(() => {
    if (Svg1Inview.inView) {
      console.log("Svg1Inview.inView", Svg1Inview.inView);
      console.log("Svg1Inview", Svg1Inview.entry.intersectionRatio);
